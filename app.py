...
def load_data():
    """
    Carga el archivo datos_energia.csv como un DataFrame de Pandas.
    Asegura que la columna de fecha esté en formato datetime y sea el índice.
    """
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", debug=True) #Cambio
